...
namespace Graphics
{
	...
	extern GpuBuffer			g_DoFWorkQueue;
	extern GpuBuffer			g_DoFFastQueue;
	extern GpuBuffer			g_DoFFixupQueue;
	...
	extern GpuBuffer			g_Histogram;
	extern GpuBuffer			g_FXAAWorkQueueH;
	extern GpuBuffer			g_FXAAWorkQueueV;
