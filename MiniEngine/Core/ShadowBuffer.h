...
public:
	...
	void Create( const std::wstring& name, size_t width, size_t height,
		D3D12_GPU_VIRTUAL_ADDRESS VidMemPtr = D3D12_GPU_VIRTUAL_ADDRESS_UNKNOWN );
	void Create( const std::wstring& name, size_t width, size_t height, EsramAllocator& esramAllocator );
