...
namespace Math
{
    ...
    public:
        ...
        static INLINE Matrix3 MakeScale( const XMFLOAT3& scale) { return Matrix3(DirectX::XMMatrixScaling(scale.x, scale.y, scale.z)); }
        ...
        INLINE operator XMMATRIX() const { return XMMATRIX(m_mat[0], m_mat[1], m_mat[2], DirectX::XMVectorZero()); }
