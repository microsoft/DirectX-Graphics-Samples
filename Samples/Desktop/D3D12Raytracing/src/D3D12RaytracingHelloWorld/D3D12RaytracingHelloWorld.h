...
// The sample supports both Fallback Layer and DirectX Raytracing APIs. 
...
private:
    ...
    size_t raygenShaderRecordOffset;
    size_t missShaderRecordOffset;
    size_t hitGroupShaderRecordOffset;
    ...
    bool LoadBinaryResource(std::wstring name, const void*& data, size_t& size)
    {
        HRSRC resourceInfo = FindResource(NULL, name.c_str(), RT_RCDATA);
