...
void D3D12RaytracingHelloWorld::CreateRaytracingPipelineStateObject()
{
    ...
    // In this sample, this could be for convenience since the sample uses all shaders in the library. 
    {
    ...
    // In this sample, this could have been ommited for convenience since it matches the default association.
    {
...
void D3D12RaytracingHelloWorld::CreateDescriptorHeap()
{
    ...
    // Allocate a heap for plenty of descriptors.
...
void D3D12RaytracingHelloWorld::BuildGeometry()
{
    ...
    AllocateUploadBuffer(device, triangleVerts, sizeof(triangleVerts), &m_vertexBuffer);
    AllocateUploadBuffer(device, indicies, sizeof(indicies), &m_indexBuffer);
}
