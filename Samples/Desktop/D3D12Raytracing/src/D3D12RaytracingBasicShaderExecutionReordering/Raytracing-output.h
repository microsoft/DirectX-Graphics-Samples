...
; g_objectCB                          cbuffer      NA          NA     CB1            cb1     1
...
%g_objectCB = type { %struct.ObjectConstantBuffer }
...
@g_objectCB = external constant %dx.types.Handle
...
define void @"\01?MyClosestHitShader@@YAXURayPayload@@UBuiltInTriangleIntersectionAttributes@@@Z"(%struct.RayPayload* noalias nocapture %payload, %struct.BuiltInTriangleIntersectionAttributes* nocapture readonly %attr) #0 {
  ...
  %3 = load %dx.types.Handle, %dx.types.Handle* @g_objectCB, align 4
...
!15 = !{i32 1, %g_objectCB* bitcast (%dx.types.Handle* @g_objectCB to %g_objectCB*), !"g_objectCB", i32 0, i32 1, i32 1, i32 20, null}
