...
class D3D12RaytracingBasicShaderExecutionReordering : public DXSample
{
public:
    D3D12RaytracingBasicShaderExecutionReordering(UINT width, UINT height, std::wstring name);
...
private:
    ...
    ObjectConstantBuffer m_complexShapeCB;
