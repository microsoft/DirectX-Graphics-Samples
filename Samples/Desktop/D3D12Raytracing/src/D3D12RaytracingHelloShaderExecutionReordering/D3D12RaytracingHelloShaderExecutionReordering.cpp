...
const wchar_t* D3D12RaytracingHelloShaderExecutionReordering::c_hitGroupName = L"MyHitGroup";
const wchar_t* D3D12RaytracingHelloShaderExecutionReordering::c_raygenShaderName = L"MyRaygenShader";
const wchar_t* D3D12RaytracingHelloShaderExecutionReordering::c_closestHitShaderName = L"MyClosestHitShader";
const wchar_t* D3D12RaytracingHelloShaderExecutionReordering::c_missShaderName = L"MyMissShader";
...
D3D12RaytracingHelloShaderExecutionReordering::D3D12RaytracingHelloShaderExecutionReordering(UINT width, UINT height, std::wstring name) :
...
void D3D12RaytracingHelloShaderExecutionReordering::CreateDeviceDependentResources()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::SerializeAndCreateRaytracingRootSignature(D3D12_ROOT_SIGNATURE_DESC& desc, ComPtr<ID3D12RootSignature>* rootSig)
{
...
void D3D12RaytracingHelloShaderExecutionReordering::CreateRootSignatures()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::CreateRaytracingInterfaces()
{
    auto device = m_deviceResources->GetD3DDevice();
...
// This is a root signature that enables a shader to have unique arguments that come from shader tables.
void D3D12RaytracingHelloShaderExecutionReordering::CreateLocalRootSignatureSubobjects(CD3DX12_STATE_OBJECT_DESC* raytracingPipeline)
{
...
void D3D12RaytracingHelloShaderExecutionReordering::CreateRaytracingOutputResource()
{
    auto device = m_deviceResources->GetD3DDevice();
...
void D3D12RaytracingHelloShaderExecutionReordering::CreateDescriptorHeap()
{
    auto device = m_deviceResources->GetD3DDevice();
...
void D3D12RaytracingHelloShaderExecutionReordering::BuildGeometry()
{
    auto device = m_deviceResources->GetD3DDevice();
    Index indices[] =
    {
...
void D3D12RaytracingHelloShaderExecutionReordering::BuildAccelerationStructures()
{
    auto device = m_deviceResources->GetD3DDevice();
    auto commandList = m_deviceResources->GetCommandList();
...
void D3D12RaytracingHelloShaderExecutionReordering::BuildShaderTables()
{
    auto device = m_deviceResources->GetD3DDevice();
...
void D3D12RaytracingHelloShaderExecutionReordering::OnUpdate()
{
    m_timer.Tick();
    CalculateFrameStats();
}

void D3D12RaytracingHelloShaderExecutionReordering::DoRaytracing()
{
    auto commandList = m_deviceResources->GetCommandList();
...
void D3D12RaytracingHelloShaderExecutionReordering::UpdateForSizeChange(UINT width, UINT height)
{
...
void D3D12RaytracingHelloShaderExecutionReordering::CopyRaytracingOutputToBackbuffer()
{
    auto commandList= m_deviceResources->GetCommandList();
...
void D3D12RaytracingHelloShaderExecutionReordering::CreateWindowSizeDependentResources()
{
    CreateRaytracingOutputResource(); 
...
void D3D12RaytracingHelloShaderExecutionReordering::ReleaseWindowSizeDependentResources()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::ReleaseDeviceDependentResources()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::RecreateD3D()
{
...
// Render the scene.
void D3D12RaytracingHelloShaderExecutionReordering::OnRender()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::OnDestroy()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::OnDeviceLost()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::OnDeviceRestored()
{
    CreateDeviceDependentResources();
    CreateWindowSizeDependentResources();
}
...
void D3D12RaytracingHelloShaderExecutionReordering::CalculateFrameStats()
{
...
void D3D12RaytracingHelloShaderExecutionReordering::OnSizeChanged(UINT width, UINT height, bool minimized)
{
...
UINT D3D12RaytracingHelloShaderExecutionReordering::AllocateDescriptor(D3D12_CPU_DESCRIPTOR_HANDLE* cpuDescriptor, UINT descriptorIndexToUse)
{
