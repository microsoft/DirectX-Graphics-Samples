...
## Windows 10 May 2019 update SDK (18362) compatibility notice
DirectX Raytracing samples from "master" branch are not yet compatible with Windows 10 May 2019 update SDK (18362). Use the DirectX Raytracing samples from ["develop"](https://github.com/microsoft/DirectX-Graphics-Samples/tree/develop) branch, which already supports Windows 10 May 2019 update SDK, instead for now.
