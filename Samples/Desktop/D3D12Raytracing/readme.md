...
## Known limitations
  ...
  - AMD: current/v1.3 revision of the DXR samples and Fallback Layer are not supported on AMD cards and will fail to run. You can use previous v1.1 source and binary overlay snapshots which worked from the repository release.
