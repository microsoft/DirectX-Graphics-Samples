...
{
public:
    RenderPassBuilder(const wchar_t* name,
                      RenderPassKeys& keys,
                      RenderPassKeyRegistry& keyRegistry,
                      PassOperationRegistry<OperationHandlerT>& operationRegistry)
        : m_keys(&keys), m_keyRegistry(&keyRegistry), m_operationRegistry(&operationRegistry)
    {
        m_pass.name = name;
    }
...
public:
    ...
    RenderPassAuthoringContext(RenderPassKeys& keys,
                               RenderPassKeyRegistry& keyRegistry,
                               PassOperationRegistry<OperationHandlerT>& operationRegistry)
    {
